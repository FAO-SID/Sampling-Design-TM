...
In this manual, we use the R implementation of cLHS by [@Roudier2011] and available as an [R package](https://cran.r-project.org/web/packages/clhs/).
...
```{r load_data_05, eval=TRUE, include=TRUE, message=FALSE, warning=FALSE}
  ...
  cov.dat <- terra::rast(cov.dat) # SpatRaster from terra
   ...
   #  Disaggregate to build layer statistics
    cov.dat <- disagg(cov.dat, fact=disagg.factor, method="bilinear")
