...
```{r fig-9a, fig.cap="Plot of the soil classes", eval=TRUE, include=TRUE}
...
```{r fig-9b, fig.cap="Plot of the land use classes", eval=TRUE, include=TRUE}
...
```{r fig-10, eval=TRUE, include=TRUE, fig.cap="Plot of strata"}
...
```{r fig-11, fig.cap="Plot of strata and sampling points", eval=TRUE, include=TRUE}
...
```{r fig-12, fig.cap="Plot of strata and regular sampling points", eval=TRUE, include=TRUE}

  mapview(soil_lc["soil_lc"], alpha=0, homebutton=T, layer.name = "Strata") + mapview(z[z$type=="Target",], cex=3, color = "white", col.regions = "tomato",layer.name = "Target Points")
