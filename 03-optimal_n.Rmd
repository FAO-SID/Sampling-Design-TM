...
```{r setup_wd_03, eval=FALSE, include=FALSE}
  ...
  packages <- c("sp", "terra", "clhs", "entropy", "tripack","manipulate","dplyr","plotly", "raster", "maptools") # Create a vector of packages to use
...
According to Figure \@ref(fig:fig-8), the optimal sampling size for the area, that captures at least 95% of the environmental variability of covariates is `r optimal_n`.
...
plot(cov.dat[[1]])
N_final <- samples_storage[paste0("N",ceiling(optimal_n/by.n)*by.n,"_", optimal_iteration$IDX)][[1]]
points(N_final)
